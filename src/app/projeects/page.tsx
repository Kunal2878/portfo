...
function Projects() {
  ...
  return ( 
    <div className='w-full flex justify-center items-center flex-col bg-red-200 min-h-screen  p-6'>
<div className='w-full flex flex-row justify-center items-center text-black font-bold text-[20px]'> <span className='size-4 bg-blue-600 mr-3'></span> Projects</div>
        {
